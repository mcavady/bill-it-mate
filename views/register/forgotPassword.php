<div id='wrapper'>
<div id="content">
	<h1>Bill It Mate - New Password</h1>
  <div class="login_form">
	...
	?>
      ...
      <h4>New Password</h4><div class="required">*</div>
	...
	?>
      ...
      <h4>New Password Confirm</h4><div class="required">*</div>
	...
	if(isset($error[8])) {
		echo "<div class='error'>" .$error[8] . "</div>";
	}
	?>

      <div class="login_button"><input type='submit' name="submit" value='Enable New Password'></div>
	<?php
		if($data['success'] == true){
        	echo "<h3>New Password Complete</h3>";
        	echo "<p>Check your email for a confirmation</p>";
    		}
	?>
